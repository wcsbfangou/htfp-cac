...
import com.htfp.service.cac.router.biz.service.tcp.server.handler.NettyServerHandlerInitializer;
...
@Slf4j
@Component
public class GcsTcpDataTransferServer {

    @Value("${gcsTcpDataTransfer.routerPort}")
