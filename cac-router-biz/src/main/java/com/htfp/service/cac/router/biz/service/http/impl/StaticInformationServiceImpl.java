 ...
 */
@Slf4j
@Service("staticInformationServiceImpl")
public class StaticInformationServiceImpl implements IStaticInformationService {
                ...
                if (!StaticInfoStatusEnum.REGISTERING.equals(pilotStatus)) {
                    ...
                    if (id > 0) {
                        if (StaticInfoStatusEnum.REGISTERED.equals(pilotStatus)) {
                            ...
                            com.htfp.service.oac.biz.model.inner.response.UpdatePilotInfoResponse oacUpdatePilotInfoResponse = basicInfoService.updatePilotInfo(oacUpdatePilotInfoRequest);
    ...
    UpdatePilotInfoResponse buildUpdatePilotInfoResponse(com.htfp.service.oac.biz.model.inner.response.UpdatePilotInfoResponse oavUpdatePilotInfoResponse) {
        UpdatePilotInfoResponse updatePilotInfoResponse = new UpdatePilotInfoResponse();
                ...
                if (!StaticInfoStatusEnum.REGISTERING.equals(operatorStatus)) {
                    ...
                    if (id > 0) {
                        if (StaticInfoStatusEnum.REGISTERED.equals(operatorStatus)) {
                            ...
                            com.htfp.service.oac.biz.model.inner.response.UpdateOperatorInfoResponse oacUpdateOperatorInfoResponse = basicInfoService.updateOperatorInfo(oacUpdateOperatorInfoRequest);
    ...
    UpdateOperatorInfoResponse buildUpdateOperatorInfoResponse(com.htfp.service.oac.biz.model.inner.response.UpdateOperatorInfoResponse oacUpdateOperatorInfoResponse) {
        UpdateOperatorInfoResponse updateOperatorInfoResponse = new UpdateOperatorInfoResponse();
                        ...
                        if (id > 0) {
                            if (StaticInfoStatusEnum.REGISTERED.equals(StaticInfoStatusEnum.getFromCode(queryOperatorInfo.getStatus()))) {
                                if (StaticInfoStatusEnum.REGISTERED.equals(uavStatus)) {
                                    ...
                                    com.htfp.service.oac.biz.model.inner.response.UpdateUavInfoResponse oacUpdateUavInfoResponse = basicInfoService.updateUavInfo(oacUpdateUavInfoRequest);
    ...
    UpdateUavInfoResponse buildUpdateUavInfoResponse(com.htfp.service.oac.biz.model.inner.response.UpdateUavInfoResponse oacUpdateUavInfoResponse) {
        UpdateUavInfoResponse updateUavInfoResponse = new UpdateUavInfoResponse();
            ...
            if (queryPilotInfo != null) {
                ...
                if (id > 0) {
                    if (StaticInfoStatusEnum.TYPE_IN != StaticInfoStatusEnum.getFromCode(queryPilotInfo.getStatus())) {
                        DeletePilotInfoRequest oacDeletePilotInfoRequest = buildOacDeletePilotInfoRequest(queryPilotInfo);
                        com.htfp.service.oac.biz.model.inner.response.DeletePilotInfoResponse oacDeletePilotInfoResponse = basicInfoService.deletePilotInfo(oacDeletePilotInfoRequest);
    ...
    DeletePilotInfoRequest buildOacDeletePilotInfoRequest(PilotInfoDO queryPilotInfo) {
        DeletePilotInfoRequest deletePilotInfoRequest = new DeletePilotInfoRequest();
        deletePilotInfoRequest.setPilotUniId(queryPilotInfo.getPilotUniId());
        return deletePilotInfoRequest;
    }

    DeletePilotInfoResponse buildDeletePilotInfoResponse(com.htfp.service.oac.biz.model.inner.response.DeletePilotInfoResponse oacDeletePilotInfoResponse) {
        DeletePilotInfoResponse deletePilotInfoResponse = new DeletePilotInfoResponse();
                ...
                if (queryOperatorInfo != null) {
                    ...
                    if (id > 0) {
                        if (StaticInfoStatusEnum.TYPE_IN != StaticInfoStatusEnum.getFromCode(queryOperatorInfo.getStatus())) {
                            DeleteOperatorInfoRequest deleteOperatorInfoRequest = buildOacDeleteOperatorInfoRequest(queryOperatorInfo);
                            com.htfp.service.oac.biz.model.inner.response.DeleteOperatorInfoResponse oacDeleteOperatorInfoResponse = basicInfoService.deleteOperatorInfo(deleteOperatorInfoRequest);
    ...
    DeleteOperatorInfoRequest buildOacDeleteOperatorInfoRequest(OperatorInfoDO queryOperatorInfo) {
        DeleteOperatorInfoRequest deleteOperatorInfoRequest = new DeleteOperatorInfoRequest();
        deleteOperatorInfoRequest.setOperatorUniId(queryOperatorInfo.getOperatorUniId());
        return deleteOperatorInfoRequest;
    }

    DeleteOperatorInfoResponse buildDeleteOperatorInfoResponse(com.htfp.service.oac.biz.model.inner.response.DeleteOperatorInfoResponse oacDeleteOperatorInfoResponse) {
        DeleteOperatorInfoResponse deleteOperatorInfoResponse = new DeleteOperatorInfoResponse();
            ...
            if (queryUavInfo != null) {
                ...
                if (id > 0) {
                    if (StaticInfoStatusEnum.TYPE_IN != StaticInfoStatusEnum.getFromCode(queryUavInfo.getStatus())) {
                        DeleteUavInfoRequest deleteUavInfoRequest = buildOacDeleteUavInfoRequest(queryUavInfo);
                        com.htfp.service.oac.biz.model.inner.response.DeleteUavInfoResponse oacDeleteUavInfoResponse = basicInfoService.deleteUavInfo(deleteUavInfoRequest);
    ...
    DeleteUavInfoRequest buildOacDeleteUavInfoRequest(UavInfoDO queryUavInfo) {
        DeleteUavInfoRequest deleteUavInfoRequest = new DeleteUavInfoRequest();
        deleteUavInfoRequest.setCpn(queryUavInfo.getCpn());
        return deleteUavInfoRequest;
    }

    DeleteUavInfoResponse buildDeleteUavInfoResponse(com.htfp.service.oac.biz.model.inner.response.DeleteUavInfoResponse oacDeleteUavInfoResponse) {
        DeleteUavInfoResponse deleteUavInfoResponse = new DeleteUavInfoResponse();
        ...
        try {
            ...
            if (queryPilotInfo != null) {
                ...
                if (StaticInfoStatusEnum.TYPE_IN.equals(pilotStatus) || StaticInfoStatusEnum.CANCELED.equals(pilotStatus)) {
                    ...
                    com.htfp.service.oac.biz.model.inner.request.RegisterPilotInfoRequest oacRegisterPilotInfoRequest = buildOacRegisterPilotInfoRequest(queryPilotInfo);
                    com.htfp.service.oac.biz.model.inner.response.RegisterPilotInfoResponse oacRegisterPilotInfoResponse = basicInfoService.registerPilotInfo(oacRegisterPilotInfoRequest);
    ...
    com.htfp.service.oac.biz.model.inner.request.RegisterPilotInfoRequest buildOacRegisterPilotInfoRequest(PilotInfoDO pilotInfo) {
        com.htfp.service.oac.biz.model.inner.request.RegisterPilotInfoRequest oacRegisterPilotInfoRequest = new com.htfp.service.oac.biz.model.inner.request.RegisterPilotInfoRequest();
    ...
    RegisterPilotInfoResponse buildOacRegisterPilotInfoResponse(com.htfp.service.oac.biz.model.inner.response.RegisterPilotInfoResponse oacRegisterPilotInfoResponse) {
        RegisterPilotInfoResponse registerPilotInfoResponse = new RegisterPilotInfoResponse();
        ...
        try {
            ...
            if (queryOperatorInfo != null) {
                ...
                if (StaticInfoStatusEnum.TYPE_IN.equals(operatorStatus) || StaticInfoStatusEnum.CANCELED.equals(operatorStatus)) {
                    ...
                    com.htfp.service.oac.biz.model.inner.request.RegisterOperatorInfoRequest oacRegisterOperatorInfoRequest = buildOacRegisterOperatorInfoRequest(queryOperatorInfo);
                    com.htfp.service.oac.biz.model.inner.response.RegisterOperatorInfoResponse oacRegisterOperatorInfoResponse = basicInfoService.registerOperatorInfo(oacRegisterOperatorInfoRequest);
    ...
    com.htfp.service.oac.biz.model.inner.request.RegisterOperatorInfoRequest buildOacRegisterOperatorInfoRequest(OperatorInfoDO operatorInfo) {
        com.htfp.service.oac.biz.model.inner.request.RegisterOperatorInfoRequest oacRegisterPilotInfoRequest = new com.htfp.service.oac.biz.model.inner.request.RegisterOperatorInfoRequest();
    ...
    RegisterOperatorInfoResponse buildOacRegisterOperatorInfoResponse(com.htfp.service.oac.biz.model.inner.response.RegisterOperatorInfoResponse oacRegisterOperatorInfoResponse) {
        RegisterOperatorInfoResponse registerOperatorInfoResponse = new RegisterOperatorInfoResponse();
            ...
            if (queryUavInfo != null) {
                ...
                if (StaticInfoStatusEnum.REGISTERED.equals(operatorStatus)) {
                    ...
                    if (StaticInfoStatusEnum.TYPE_IN.equals(uavStatus) || StaticInfoStatusEnum.CANCELED.equals(uavStatus)) {
                        ...
                        com.htfp.service.oac.biz.model.inner.request.RegisterUavInfoRequest oacRegisterUavInfoRequest = buildOacRegisterUavInfoRequest(queryUavInfo, queryOperatorInfo.getOperatorUniId());
                        com.htfp.service.oac.biz.model.inner.response.RegisterUavInfoResponse oacRegisterUavInfoResponse = basicInfoService.registerUavInfo(oacRegisterUavInfoRequest);
    ...
    com.htfp.service.oac.biz.model.inner.request.RegisterUavInfoRequest buildOacRegisterUavInfoRequest(UavInfoDO uavInfo, String operatorUniId) {
        com.htfp.service.oac.biz.model.inner.request.RegisterUavInfoRequest oacRegisterUavInfoRequest = new com.htfp.service.oac.biz.model.inner.request.RegisterUavInfoRequest();
    ...
    RegisterUavInfoResponse buildOacRegisterUavInfoResponse(com.htfp.service.oac.biz.model.inner.response.RegisterUavInfoResponse oacRegisterUavInfoResponse) {
        RegisterUavInfoResponse registerUavInfoResponse = new RegisterUavInfoResponse();
        ...
        try {
            ...
            if (queryPilotInfo != null) {
                ...
                if (StaticInfoStatusEnum.REGISTERED.equals(pilotStatus)) {
                    ...
                    com.htfp.service.oac.biz.model.inner.request.CancelPilotInfoRequest oacCancelPilotInfoRequest = buildOacCancelPilotInfoRequest(queryPilotInfo);
                    com.htfp.service.oac.biz.model.inner.response.CancelPilotInfoResponse oacCancelPilotInfoResponse = basicInfoService.cancelPilotInfo(oacCancelPilotInfoRequest);
    ...
    com.htfp.service.oac.biz.model.inner.request.CancelPilotInfoRequest buildOacCancelPilotInfoRequest(PilotInfoDO pilotInfo) {
        com.htfp.service.oac.biz.model.inner.request.CancelPilotInfoRequest oacCancelPilotInfoRequest = new com.htfp.service.oac.biz.model.inner.request.CancelPilotInfoRequest();
        oacCancelPilotInfoRequest.setPilotUniId(pilotInfo.getPilotUniId());
        return oacCancelPilotInfoRequest;
    }

    CancelPilotInfoResponse buildOacCancelPilotInfoResponse(com.htfp.service.oac.biz.model.inner.response.CancelPilotInfoResponse oacCancelPilotInfoResponse) {
        CancelPilotInfoResponse cancelPilotInfoResponse = new CancelPilotInfoResponse();
        ...
        try {
            ...
            if (queryOperatorInfo != null) {
                ...
                if (StaticInfoStatusEnum.REGISTERED.equals(operatorStatus)) {
                    ...
                    com.htfp.service.oac.biz.model.inner.request.CancelOperatorInfoRequest oacCancelOperatorInfoRequest = buildOacCancelOperatorInfoRequest(queryOperatorInfo);
                    com.htfp.service.oac.biz.model.inner.response.CancelOperatorInfoResponse oacCancelOperatorInfoResponse = basicInfoService.cancelOperatorInfo(oacCancelOperatorInfoRequest);
    ...
    com.htfp.service.oac.biz.model.inner.request.CancelOperatorInfoRequest buildOacCancelOperatorInfoRequest(OperatorInfoDO queryOperatorInfo) {
        com.htfp.service.oac.biz.model.inner.request.CancelOperatorInfoRequest oacCancelOperatorInfoRequest = new com.htfp.service.oac.biz.model.inner.request.CancelOperatorInfoRequest();
        oacCancelOperatorInfoRequest.setOperatorUniId(queryOperatorInfo.getOperatorUniId());
        return oacCancelOperatorInfoRequest;
    }

    CancelOperatorInfoResponse buildOacCancelOperatorInfoResponse(com.htfp.service.oac.biz.model.inner.response.CancelOperatorInfoResponse oacCancelOperatorInfoResponse) {
        CancelOperatorInfoResponse cancelOperatorInfoResponse = new CancelOperatorInfoResponse();
        ...
        try {
            ...
            if (queryUavInfo != null) {
                ...
                if (StaticInfoStatusEnum.REGISTERED.equals(uavStatus)) {
                    ...
                    com.htfp.service.oac.biz.model.inner.request.CancelUavInfoRequest oacCancelUavInfoRequest = buildOacCancelUavInfoRequest(queryUavInfo);
                    com.htfp.service.oac.biz.model.inner.response.CancelUavInfoResponse oacCancelUavInfoResponse = basicInfoService.cancelUavInfo(oacCancelUavInfoRequest);
    ...
    com.htfp.service.oac.biz.model.inner.request.CancelUavInfoRequest buildOacCancelUavInfoRequest(UavInfoDO queryUavInfo) {
        com.htfp.service.oac.biz.model.inner.request.CancelUavInfoRequest oacCancelUavInfoRequest = new com.htfp.service.oac.biz.model.inner.request.CancelUavInfoRequest();
        oacCancelUavInfoRequest.setCpn(queryUavInfo.getCpn());
        return oacCancelUavInfoRequest;
    }

    CancelUavInfoResponse buildOacCancelUavInfoResponse(com.htfp.service.oac.biz.model.inner.response.CancelUavInfoResponse oacCancelUavInfoResponse) {
        CancelUavInfoResponse cancelUavInfoResponse = new CancelUavInfoResponse();
