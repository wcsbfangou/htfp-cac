...
import com.htfp.service.oac.dao.mapper.ApplyUavVerifyLogMapper;
...
public class ApplyUavVerifyLogDalService {
    ...
    @Resource
    ApplyUavVerifyLogMapper applyUavVerifyLogMapper;
    ...
    public int deleteApplyUavVerifyLogByApplyUavVerifyId(Long applyUavVerifyId){
        return applyUavVerifyLogMapper.deleteByReplyUavVerifyIdId(applyUavVerifyId);
    }
