...
import com.htfp.service.oac.dao.mapper.OperatorInfoMapper;
...
public class OperatorDalService {
    ...
    public OperatorInfoDO queryOperatorInfoByOperatorUniId(String operatorUniId){
        return operatorInfoMapper.selectByOperatorUniId(operatorUniId);
    }

    public List<OperatorInfoDO> queryOperatorInfoByOperatorSourceId(String operatorSourceId){
        List<OperatorInfoDO> operatorInfoDOList = operatorInfoMapper.selectByOperatorSourceId(operatorSourceId);
    ...
    public int deleteOperatorInfoByOperatorSourceId(String operatorSourceId){
        return operatorInfoMapper.deleteByOperatorSourceId(operatorSourceId);
    }

    public int deleteOperatorInfo(Long id){
        return operatorInfoMapper.deleteById(id);
    }
