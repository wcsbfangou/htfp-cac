...
import com.htfp.service.oac.dao.mapper.PilotInfoMapper;
...
public class PilotDalService {
    ...
    public PilotInfoDO queryPilotInfo(Long id){
        return pilotInfoMapper.selectById(id);
    }

    public PilotInfoDO queryPilotInfoByPilotUniId(String pilotUniId){
        return pilotInfoMapper.selectByPilotUniId(pilotUniId);
    }

    public List<PilotInfoDO> queryPilotInfoByPilotSourceId(String pilotSourceId){
        List<PilotInfoDO> pilotInfoDOList = pilotInfoMapper.selectByPilotSourceId(pilotSourceId);
    ...
    public int deletePilotInfoByPilotSourceId(String pilotSourceId){
        return pilotInfoMapper.deleteByPilotSourceId(pilotSourceId);
    }
