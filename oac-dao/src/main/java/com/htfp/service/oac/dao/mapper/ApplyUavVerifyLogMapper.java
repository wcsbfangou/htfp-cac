...
public interface ApplyUavVerifyLogMapper {
    ...
    @Insert("INSERT INTO " + TABLE + " (apply_uav_verify_id, reply_uav_verify_id, cpn, lng, lat, alt, ground_speed, relative_height, flight_control_sn, flight_control_version, uav_dynamic_param, uav_static_param, status, gmt_create, gmt_modify) "
            + "VALUES (#{applyUavVerifyLog.applyUavVerifyId}, #{applyUavVerifyLog.replyUavVerifyId}, #{applyUavVerifyLog.cpn}, #{applyUavVerifyLog.lng}, #{applyUavVerifyLog.lat}, #{applyUavVerifyLog.alt}, #{applyUavVerifyLog.groundSpeed}, #{applyUavVerifyLog.relativeHeight}, #{applyUavVerifyLog.flightControlSn}, #{applyUavVerifyLog.flightControlVersion}, #{applyUavVerifyLog.uavDynamicParam}, #{applyUavVerifyLog.uavStaticParam}, #{applyUavVerifyLog.missionType}, #{applyUavVerifyLog.status}, #{applyUavVerifyLog.gmtCreate}, #{applyUavVerifyLog.gmtModify})"
            + " ON DUPLICATE KEY UPDATE reply_uav_verify_id=#{applyUavVerifyLog.replyUavVerifyId}, cpn=#{applyUavVerifyLog.cpn}, lng=#{applyUavVerifyLog.lng}, lat=#{applyUavVerifyLog.lat}, alt=#{applyUavVerifyLog.alt}, ground_speed=#{applyUavVerifyLog.groundSpeed}, relative_height=#{applyUavVerifyLog.relativeHeight}, flight_control_sn=#{applyUavVerifyLog.flightControlSn}, flight_control_version=#{applyUavVerifyLog.flightControlVersion}, uav_dynamic_param=#{applyUavVerifyLog.uavDynamicParam}, uav_static_param=#{applyUavVerifyLog.uavStaticParam}, status=#{applyUavVerifyLog.status}, gmt_modify=#{applyUavVerifyLog.gmtModify}, is_del = 0")
    @Options(useGeneratedKeys = true, keyProperty = "applyUavVerifyLogDO.id")
