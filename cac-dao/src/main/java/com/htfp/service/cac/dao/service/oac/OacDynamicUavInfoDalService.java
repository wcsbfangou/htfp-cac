...
public class OacDynamicUavInfoDalService {
    ...
    public DynamicUavInfoDO buildDynamicUavInfoDO(Long replyFlightPlanId, Long replyFlyId, String uavName, String cpn, Integer uavProductType, String uavOperatorName, Integer lng, Integer lat, Integer alt,
        ...
        dynamicUavInfoDO.setUavProductType(uavProductType);
