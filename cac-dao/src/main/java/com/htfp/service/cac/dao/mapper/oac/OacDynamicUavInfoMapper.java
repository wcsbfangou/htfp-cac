...
public interface OacDynamicUavInfoMapper {
     ...
     * @return
     */
    @Insert("INSERT INTO " + TABLE + " (reply_flight_plan_id, reply_fly_id, uav_name, cpn, uav_operator_name, lng, lat, alt, speed, course, fuel, battery, signal_strength, update_time, flight_plan_start_time, flight_plan_end_time, start_fly_time, takeoff_airport_id, landing_airport_id, takeoff_site, landing_site, landing_airport_identification_radius, landing_airport_alarm_radius, landing_lng, landing_lat, landing_alt, distance_to_landing_point, in_alarm, alarm_ids, access_system, plan_status, uav_status, gmt_create, gmt_modify) "
