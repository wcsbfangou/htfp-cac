...
@Mapper
@Repository
public interface OacDynamicUavInfoMapper {

    String TABLE = "oac_dynamic_uav_info";
     ...
     * @return
     */
    @Insert("INSERT INTO " + TABLE + " (reply_flight_plan_id, reply_fly_id, uav_name, cpn, uav_product_type, uav_operator_name, lng, lat, alt, speed, course, fuel, battery, signal_strength, update_time, flight_plan_start_time, flight_plan_end_time, start_fly_time, takeoff_airport_id, landing_airport_id, takeoff_site, landing_site, landing_airport_identification_radius, landing_airport_alarm_radius, landing_lng, landing_lat, landing_alt, distance_to_landing_point, in_alarm, alarm_ids, access_system, plan_status, uav_status, gmt_create, gmt_modify) "
            + "VALUES (#{dynamicUavInfoDO.replyFlightPlanId}, #{dynamicUavInfoDO.replyFlyId}, #{dynamicUavInfoDO.uavName}, #{dynamicUavInfoDO.cpn}, #{dynamicUavInfoDO.uavProductType}, #{dynamicUavInfoDO.uavOperatorName}, #{dynamicUavInfoDO.lng}, #{dynamicUavInfoDO.lat}, #{dynamicUavInfoDO.alt}, #{dynamicUavInfoDO.speed}, #{dynamicUavInfoDO.course}, #{dynamicUavInfoDO.fuel}, #{dynamicUavInfoDO.battery}, #{dynamicUavInfoDO.signalStrength}, #{dynamicUavInfoDO.updateTime}, #{dynamicUavInfoDO.flightPlanStartTime}, #{dynamicUavInfoDO.flightPlanEndTime}, #{dynamicUavInfoDO.startFlyTime}, #{dynamicUavInfoDO.takeoffAirportId}, #{dynamicUavInfoDO.landingAirportId}, #{dynamicUavInfoDO.takeoffSite}, #{dynamicUavInfoDO.landingSite}, #{dynamicUavInfoDO.landingAirportIdentificationRadius}, #{dynamicUavInfoDO.landingAirportAlarmRadius}, #{dynamicUavInfoDO.landingLng}, #{dynamicUavInfoDO.landingLat}, #{dynamicUavInfoDO.landingAlt}, #{dynamicUavInfoDO.distanceToLandingPoint}, #{dynamicUavInfoDO.inAlarm}, #{dynamicUavInfoDO.alarmIds}, #{dynamicUavInfoDO.accessSystem}, #{dynamicUavInfoDO.planStatus}, #{dynamicUavInfoDO.uavStatus}, #{dynamicUavInfoDO.gmtCreate}, #{dynamicUavInfoDO.gmtModify})"
            + " ON DUPLICATE KEY UPDATE uav_name=#{dynamicUavInfoDO.uavName}, cpn=#{dynamicUavInfoDO.cpn}, uav_product_type=#{dynamicUavInfoDO.uavProductType}, uav_operator_name=#{dynamicUavInfoDO.uavOperatorName}, lng=#{dynamicUavInfoDO.lng}, lat=#{dynamicUavInfoDO.lat}, alt=#{dynamicUavInfoDO.alt}, speed=#{dynamicUavInfoDO.speed}, course=#{dynamicUavInfoDO.course}, fuel=#{dynamicUavInfoDO.fuel}, battery=#{dynamicUavInfoDO.battery}, signal_strength=#{dynamicUavInfoDO.signalStrength}, update_time=#{dynamicUavInfoDO.updateTime}, flight_plan_start_time=#{dynamicUavInfoDO.flightPlanStartTime}, flight_plan_end_time=#{dynamicUavInfoDO.flightPlanEndTime}, start_fly_time=#{dynamicUavInfoDO.startFlyTime}, takeoff_airport_id=#{dynamicUavInfoDO.takeoffAirportId}, landing_airport_id=#{dynamicUavInfoDO.landingAirportId}, takeoff_site=#{dynamicUavInfoDO.takeoffSite}, landing_site=#{dynamicUavInfoDO.landingSite}, landing_airport_identification_radius=#{dynamicUavInfoDO.landingAirportIdentificationRadius}, landing_airport_alarm_radius=#{dynamicUavInfoDO.landingAirportAlarmRadius}, landing_lng=#{dynamicUavInfoDO.landingLng}, landing_lat=#{dynamicUavInfoDO.landingLat}, landing_alt=#{dynamicUavInfoDO.landingAlt}, distance_to_landing_point=#{dynamicUavInfoDO.distanceToLandingPoint}, in_alarm=#{dynamicUavInfoDO.inAlarm}, alarm_ids=#{dynamicUavInfoDO.alarmIds}, access_system=#{dynamicUavInfoDO.accessSystem}, plan_status=#{dynamicUavInfoDO.planStatus}, uav_status=#{dynamicUavInfoDO.uavStatus}, gmt_modify=#{dynamicUavInfoDO.gmtModify}, is_del = 0")
    ...
    @Update("<script> UPDATE " + TABLE + " <set> "
            ...
            + "<if test=\"dynamicUavInfoDO.signalStrength != null\"> signal_strength = #{dynamicUavInfoDO.signalStrength}, </if>"
            ...
            + "<if test=\"dynamicUavInfoDO.landingLng != null\"> landing_lng = #{dynamicUavInfoDO.landingLng}, </if>"
            + "<if test=\"dynamicUavInfoDO.landingLat != null\"> landing_lat = #{dynamicUavInfoDO.landingLat}, </if>"
            + "<if test=\"dynamicUavInfoDO.landingAlt != null\"> landing_alt = #{dynamicUavInfoDO.landingAlt}, </if>"
