...
public interface ApplyFlyLogMapper {
    ...
    @Insert("INSERT INTO " + TABLE + " (apply_fly_id, reply_fly_id, apply_flight_plan_id, reply_flight_plan_id, navigation_id, gcs_id, uav_id, uav_reg, cpn, airspace_numbers, operation_scenario_type, fly_lng, fly_lat, fly_alt, vin, pvin, flight_control_sn, imei, status, gmt_create, gmt_modify) "
            + "VALUES (#{applyFlyLog.applyFlyId}, #{applyFlyLog.applyFlyId}, #{applyFlyLog.applyFlightPlanId}, #{applyFlyLog.replyFlightPlanId}, #{applyFlyLog.navigationId}, #{applyFlyLog.gcsId}, #{applyFlyLog.uavId}, #{applyFlyLog.uavReg}, #{applyFlyLog.cpn}, #{applyFlyLog.airspaceNumbers}, #{applyFlyLog.operationScenarioType}, #{applyFlyLog.flyLng}, #{applyFlyLog.flyLat}, #{applyFlyLog.flyAlt}, #{applyFlyLog.vin}, #{applyFlyLog.pvin}, #{applyFlyLog.flightControlSn}, #{applyFlyLog.imei}, #{applyFlyLog.status}, #{applyFlyLog.gmtCreate}, #{applyFlyLog.gmtModify})"
    ...
    @Update("<script> UPDATE " + TABLE + " <set> "
            ...
            + "<if test=\"applyFlyLog.operationScenarioType != null\"> operationScenarioType = #{applyFlyLog.operationScenarioType}, </if>"
            ...
            + "<if test=\"applyFlyLog.flightControlSn != null\"> flightControl_sn = #{applyFlyLog.flightControlSn}, </if>"
